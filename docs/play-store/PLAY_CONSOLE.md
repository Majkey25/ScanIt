...
| Ads | No in stable `playRelease`; yes in the version 34 Closed beta |

## Closed testing Premium setup

Version code 34 (`1.6.0-vip-ads.8`) is the ads and Premium candidate for Closed
...
- Does the app contain ads? **Yes for the version 34 Closed beta; no for stable `playRelease`.**
